...
function PricingCard({
  ...
  return (
    <div
      className={`rounded-lg p-6 ${highlighted
    ...
    >
      ...
      <Link
        href={buttonLink}
        className={`w-full inline-flex h-10 items-center justify-center rounded-md px-8 py-2 text-sm font-medium shadow transition-colors ${highlighted
